...
# Spillinnstillinger#
#Disse kan fint endres på men gjør det lokalt#
asteroidDensity = 4  # Denne styrer hvor ofte det kommer asterioder (øker sjansen ved å senke verdien)
loopTime = 10        # Denne styrer hvor lenge et level varer 
gameSpeed = 800      # Bestemmer hastigheten asteroidene beveger seg (jo høyere verdi jo saktere går det)
nextLvlAt = 20       # Hvor mye vanskligere det blir per level
